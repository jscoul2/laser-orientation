...
-   there are 603 rows with 30 variables
...
-   cases such as students or faculty
...
```{r}
d |> 
  select(student_id, total_points_possible, total_points_earned, subject)
```
...
-   \# of students who are 70% or smaller is 135

-   \# of students who are 70% or larger is 438
...
```{r}
ggplot(d, aes(x = Points_Earned, y = FinalGradeCEMS)) +
  geom_point()
```
